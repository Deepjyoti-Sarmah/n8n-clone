              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    ...
                    for simple values or {"{{json variable}}"} to strigify
                    objects
                  </FormDescription>
                  <FormMessage />
                </FormItem>
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea
                      ...
                      className="min-h-[120px] font-monotext-sm"
                    />
                  </FormControl>
                  <FormDescription>
                    The prompt to send to the AI. Use {"{{variables}}"} for
                    simple values or {"{{json variable}}"} to strigify objects
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
